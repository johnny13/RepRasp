...
<?php
  ...
  // Check if used broswer is Midori. If yes, then forward to Midori optimized webpage (Change webcam STREAM to SNAPSHOT)
  if (strpos($appversion,'Midori')) {header('Location: index6a_midori.php');} ;
?>
<hr>

&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 <a href="index6_fullscreen_midori.php"><img alt="" src="http://127.0.0.1:8080/?action=snapshot" width="220" height="165" />
