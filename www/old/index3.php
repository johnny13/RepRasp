...
exec("bash ./get_api_files.sh");
// load variable from file
//$var_files = file_get_contents('/tmp/var_files');
//$var_files_with_line_number = file_get_contents('/tmp/var_files_with_line_number');
$var_files = file('/tmp/var_files');
$var_files_amount = file_get_contents('/tmp/var_files_amount');

?>
<hr>

<u>Files ( <?php echo $var_files_amount;?>):</u>
<br>
<FORM>
<SELECT NAME="list1" TITLE="Select File"  SIZE="5" >
...
<br>
<br>
<INPUT TYPE="BUTTON" VALUE="LOAD" STYLE="height:30px; width:120px"
onClick="self.location.href='index3_file_select.php?filename=' + this.form.list1.options[this.form.list1.selectedIndex].value">
&nbsp&nbsp&nbsp&nbsp&nbsp
<INPUT TYPE="BUTTON" VALUE="LOAD & PRINT" STYLE="height:30px; width:120px"
onClick="self.location.href='index3_file_select_and_print.php?filename=' + this.form.list1.options[this.form.list1.selectedIndex].value">
